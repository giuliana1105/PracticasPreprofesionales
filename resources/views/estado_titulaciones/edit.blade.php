...
@section('content')
<div class="container">
    <h1>Editar Estado de Titulación</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('estado-titulaciones.update', $estadoTitulacion->id_estado) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nombre_estado" name="nombre_estado" 
                               value="{{ old('nombre_estado', $estadoTitulacion->nombre_estado) }}" required>
