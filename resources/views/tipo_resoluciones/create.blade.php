...
<div class="container">
    ...
    <h1 class="page-title">Crear Tipo de Resolución</h1>
        ...
        <div class="card-body">
            <form action="{{ route('tipo_resoluciones.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre_tipo_res" name="nombre_tipo_res" value="{{ old('nombre_tipo_res') }}" required autofocus>
