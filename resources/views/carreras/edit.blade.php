        ...
        <div class="card-body">
            <form action="{{ route('carreras.update', $carrera->id_carrera) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre_carrera" name="nombre_carrera" value="{{ old('nombre_carrera', $carrera->nombre_carrera) }}" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="siglas_carrera" name="siglas_carrera" value="{{ old('siglas_carrera', $carrera->siglas_carrera) }}" required>
                    @error('siglas_carrera')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
