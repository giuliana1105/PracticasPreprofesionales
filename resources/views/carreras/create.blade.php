...
<div class="container">
    ...
    <h1 class="page-title">Crear Carrera</h1>
        ...
        <div class="card-body">
            <form action="{{ route('carreras.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre_carrera" name="nombre_carrera" value="{{ old('nombre_carrera') }}" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="siglas_carrera" name="siglas_carrera" value="{{ old('siglas_carrera') }}" required>
